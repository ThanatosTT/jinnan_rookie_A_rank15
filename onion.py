...
train = pd.read_csv('original_data/train.csv', encoding='gb18030')
test = pd.read_csv('original_data/test.csv', encoding='gb18030')
...
# 还原train target compare_id 被减id
